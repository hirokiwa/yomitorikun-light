...
export const renderLocalizedHtml = (
  ...
  const localizedTemplate = templateHtml.replace(placeholderPattern, (_, placeholderName: string) => {
  ...
  const contentLocalizedTemplate = localeDefinition.code === 'en' && localeDefinition.pageId === 'privacy'
